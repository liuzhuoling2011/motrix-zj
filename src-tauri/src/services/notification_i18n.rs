...
const EN_US_TEXTS: TaskNotificationTexts = TaskNotificationTexts {
    ...
    ed2k_complete_body: "Sharing started: {taskName}",
...
pub fn texts_for_locale(locale: &str) -> TaskNotificationTexts {
    match resolve_supported_locale(locale) {
        "ar" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "بدأت المشاركة: {taskName}",
        ...
        "bg" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Споделянето започна: {taskName}",
        ...
        "ca" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "S\'ha iniciat la compartició: {taskName}",
        ...
        "de" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Teilen gestartet: {taskName}",
        ...
        "el" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Ξεκίνησε η κοινή χρήση: {taskName}",
        ...
        "es" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Compartición iniciada: {taskName}",
        ...
        "fa" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "اشتراک‌گذاری آغاز شد: {taskName}",
        ...
        "fr" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Partage démarré : {taskName}",
        ...
        "hu" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Megosztás elindult: {taskName}",
        ...
        "hi" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "साझा करना शुरू हुआ: {taskName}",
        ...
        "id" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Berbagi dimulai: {taskName}",
        ...
        "it" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Condivisione avviata: {taskName}",
        ...
        "ja" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "共有を開始しました：{taskName}",
        ...
        "ko" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "공유 시작됨: {taskName}",
        ...
        "nb" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Deling startet: {taskName}",
        ...
        "nl" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Delen gestart: {taskName}",
        ...
        "pl" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Udostępnianie rozpoczęte: {taskName}",
        ...
        "pt-BR" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Compartilhamento iniciado: {taskName}",
        ...
        "ro" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Distribuirea a început: {taskName}",
        ...
        "ru" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Раздача началась: {taskName}",
        ...
        "th" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "เริ่มแชร์แล้ว: {taskName}",
        ...
        "tr" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Paylaşım başladı: {taskName}",
        ...
        "uk" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Роздачу розпочато: {taskName}",
        ...
        "vi" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "Đã bắt đầu chia sẻ: {taskName}",
        ...
        "zh-CN" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "已开始共享：{taskName}",
        ...
        "zh-TW" => TaskNotificationTexts {
            ...
            ed2k_complete_body: "已開始共享：{taskName}",
