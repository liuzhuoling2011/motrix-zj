export default {
  ...
  'app-log-path': '日志文件',
  'download-session-path': '会话文件',
  'session-reset': '清除所有任务',
  'session-reset-confirm': '将从引擎中移除所有下载任务并删除会话文件。已完成的下载历史不受影响。',
  ...
  'clear-all-tasks-confirm': '将从引擎中移除所有下载任务并删除会话文件。已完成的下载历史不受影响。',
  'log-section': '应用日志',
  'log-path': '日志文件',
  'clear-log': '清空日志',
