export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Last ned alle magnetfiler som standard',
  'auto-select-all-magnet-files-from-extension-hint': 'Når dette er aktivert, starter magnetoppgaver stille',
