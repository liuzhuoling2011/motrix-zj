export default {
  ...
  'app-log-path': 'Loggfil',
  'download-session-path': 'Øktfil',
  'session-reset': 'Fjern alle oppgaver',
  'session-reset-confirm': 'Alle nedlastingsoppgaver fjernes fra motoren og øktfilen slettes. Historikk over fullførte nedlastinger påvirkes ikke.',
  ...
  'db-maintenance': 'Nedlastingshistorikk',
  'reset': 'Tilbakestill',
  'tray': 'Systemskuff',
  ...
  'clear-all-tasks-confirm': 'Alle nedlastingsoppgaver fjernes fra motoren og øktfilen slettes. Historikk over fullførte nedlastinger påvirkes ikke.',
