export default {
  ...
  'apply': 'Bruk',
  'proxy-applied': 'Proxy-innstillinger brukt',
  'proxy-applied-restart': 'Proxy brukt, oppgaven kobles til på nytt',
  'proxy-apply-failed': 'Kunne ikke bruke proxy-innstillinger',
