export default {
  ...
  'app-log-path': 'Protokolldatei',
  'download-session-path': 'Sitzungsdatei',
  'session-reset': 'Alle Aufgaben löschen',
  'session-reset-confirm': 'Alle Download-Aufgaben werden aus der Engine entfernt und die Sitzungsdatei gelöscht. Der Verlauf abgeschlossener Downloads bleibt erhalten.',
  ...
  'db-maintenance': 'Download-Verlauf',
  'reset': 'Zurücksetzen',
  'tray': 'Taskleiste',
  ...
  'session-path': 'Sitzungsdatei',
  'clear-all-tasks': 'Alle Aufgaben löschen',
  'clear-all-tasks-confirm': 'Alle Download-Aufgaben werden aus der Engine entfernt und die Sitzungsdatei gelöscht. Der Verlauf abgeschlossener Downloads bleibt erhalten.',
