export default {
  ...
  'db-check': 'Datenbank prüfen',
  'db-check-running': 'Datenbank-Integrität wird geprüft...',
  'db-check-ok': 'Datenbank ist in Ordnung',
  'db-check-fail': 'Datenbank-Prüfung fehlgeschlagen',
