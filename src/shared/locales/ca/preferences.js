export default {
  ...
  'app-log-path': 'Fitxer de registre',
  'download-session-path': 'Fitxer de sessió',
  'session-reset': 'Esborra totes les tasques',
  'session-reset-confirm': 'S\'eliminaran totes les tasques de descàrrega del motor i el fitxer de sessió. L\'historial de descàrregues completades no es veurà afectat.',
  ...
  'db-maintenance': 'Historial de descàrregues',
  'reset': 'Restablir',
