export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Baixa tots els fitxers magnet per defecte',
  'auto-select-all-magnet-files-from-extension-hint': 'Quan estigui activat, les tasques magnet començaran en silenci',
