export default {
  ...
  'allow-remote-access-hint': "Permet que els dispositius de la LAN accedeixin a aria2 RPC i a l'API de l'extensió",
  'remote-access-secret-required': "L'accés remot requereix el secret RPC i el secret de l'API de l'extensió",
