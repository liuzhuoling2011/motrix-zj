export default {
  ...
  'db-check': 'Comprovar base de dades',
  'db-check-running': 'Comprovant la integritat de la base de dades...',
  'db-check-ok': 'La base de dades és correcta',
  'db-check-fail': 'Error en la comprovació de la base de dades',
