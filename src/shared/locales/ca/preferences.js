export default {
  ...
  'proxy-system-socks-rejected': 'El proxy del sistema és un protocol SOCKS, no compatible amb aria2',
  'proxy-mode-manual': 'Manual',
  'proxy-mode-system': 'Proxy del sistema',
  'proxy-mode-none': 'Directe',
