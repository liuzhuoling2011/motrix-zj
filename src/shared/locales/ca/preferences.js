export default {
  ...
  'hardware-rendering': 'Renderització per maquinari (Linux)',
  'hardware-rendering-hint': 'Activa el renderitzat DMA-BUF de la GPU per a un millor rendiment. Es desactivarà automàticament si causa un error.',
  'hardware-rendering-restart-confirm': 'El canvi de renderització per maquinari requereix reiniciar l\'aplicació.',
