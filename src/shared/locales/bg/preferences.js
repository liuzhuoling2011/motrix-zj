export default {
  ...
  'db-check': 'Проверка на базата данни',
  'db-check-running': 'Проверка на целостта на базата данни...',
  'db-check-ok': 'Базата данни е наред',
  'db-check-fail': 'Проверката на базата данни е неуспешна',
