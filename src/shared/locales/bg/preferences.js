export default {
  ...
  'hardware-rendering': 'Хардуерно рендериране (Linux)',
  'hardware-rendering-hint': 'Активиране на DMA-BUF GPU рендериране за по-добра производителност. Автоматично се деактивира при срив.',
  'hardware-rendering-restart-confirm': 'Промяната в хардуерното рендериране изисква рестартиране на приложението.',
