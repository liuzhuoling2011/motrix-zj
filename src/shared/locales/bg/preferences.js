export default {
  ...
  'hardware-rendering-hint': 'Активира WebKitGTK DMA-BUF рендерер. Изключено по подразбиране за съвместимост; подобрява производителността, но се изключва автоматично при проблеми.',
