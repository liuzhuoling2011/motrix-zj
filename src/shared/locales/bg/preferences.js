export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Изтегляй всички magnet файлове по подразбиране',
  'auto-select-all-magnet-files-from-extension-hint': 'Когато е включено, magnet задачите стартират тихо',
