export default {
  ...
  'app-log-path': 'Файл на дневника',
  'download-session-path': 'Файл на сесията',
  'session-reset': 'Изчисти всички задачи',
  'session-reset-confirm': 'Това ще премахне всички задачи за изтегляне от двигателя и ще изтрие файла на сесията. Историята на завършените изтегляния няма да бъде засегната.',
  ...
  'db-maintenance': 'История на изтеглянията',
  'reset': 'Нулиране',
  ...
  'engine-section': 'Двигател',
  'session-path': 'Файл на сесията',
  'clear-all-tasks': 'Изчисти всички задачи',
  'clear-all-tasks-confirm': 'Това ще премахне всички задачи за изтегляне от двигателя и ще изтрие файла на сесията. Историята на завършените изтегляния няма да бъде засегната.',
  'log-section': 'Дневник',
