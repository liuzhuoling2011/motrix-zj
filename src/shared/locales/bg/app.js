export default {
  ...
  'engine-port-conflict-hint': 'Възможни причини:\n• Порт {port} е зает от друга програма\n• VPN, прокси или мрежов ускорител прехваща локалната комуникация\n• Защитна стена или антивирус блокира връзката на двигателя\n\nРешение: Отидете в Разширени настройки, за да промените порта на двигателя, или временно затворете съответния софтуер и опитайте отново.',
