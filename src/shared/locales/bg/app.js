export default {
  ...
  'protocol-hijacked-title': 'Програмата по подразбиране е променена',
  'protocol-hijacked-body': '{protocols} вече не се отваря от Motrix Next',
  'protocol-hijacked-dialog-content': 'Програмата по подразбиране за {protocols} е променена от друго приложение. Motrix Next вече няма да се отваря автоматично при натискане на тези връзки.\n\nСъответният превключвател е изключен автоматично. Можете да го включите отново в Настройки.',
  'dismiss': 'Разбрах',
}
