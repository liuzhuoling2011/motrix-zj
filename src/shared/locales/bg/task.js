export default {
  ...
  'apply': 'Приложи',
  'proxy-applied': 'Настройките за прокси са приложени',
  'proxy-applied-restart': 'Прокси приложено, задачата ще се свърже отново',
  'proxy-apply-failed': 'Неуспешно прилагане на прокси',
