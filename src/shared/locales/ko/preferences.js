export default {
  ...
  'hardware-rendering': '하드웨어 렌더링 (Linux)',
  'hardware-rendering-hint': '더 나은 성능을 위해 DMA-BUF GPU 렌더링을 활성화합니다. 충돌이 발생하면 자동으로 비활성화됩니다.',
  'hardware-rendering-restart-confirm': '하드웨어 렌더링 변경은 앱 재시작 후 적용됩니다.',
