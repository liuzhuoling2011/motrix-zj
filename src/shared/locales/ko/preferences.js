export default {
  ...
  'app-log-path': '로그 파일',
  'download-session-path': '세션 파일',
  'session-reset': '모든 작업 삭제',
  'session-reset-confirm': '모든 다운로드 작업이 엔진에서 제거되고 세션 파일이 삭제됩니다. 완료된 다운로드 기록에는 영향을 미치지 않습니다.',
  'factory-reset': '초기화',
  ...
  'clear-all-tasks-confirm': '모든 다운로드 작업이 엔진에서 제거되고 세션 파일이 삭제됩니다. 완료된 다운로드 기록에는 영향을 미치지 않습니다.',
  'log-section': '앱 로그',
  'log-path': '로그 파일',
  'clear-log': '로그 지우기',
