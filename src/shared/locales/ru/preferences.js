export default {
  ...
  'db-check': 'Проверить базу данных',
  'db-check-running': 'Проверка целостности базы данных...',
  'db-check-ok': 'База данных в порядке',
  'db-check-fail': 'Проверка базы данных не удалась',
