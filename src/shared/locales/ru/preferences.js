export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'По умолчанию загружать все файлы magnet',
  'auto-select-all-magnet-files-from-extension-hint': 'Если включено, задачи magnet запускаются тихо',
