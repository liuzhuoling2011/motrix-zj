export default {
  ...
  'ed2k-bootstrap-hint': 'Синхронизирует ED2K-серверы и узлы Kad для более быстрого подключения',
  'ed2k-server-met-url': 'URL server.met',
  'ed2k-nodes-dat-url': 'URL nodes.dat',
  'ed2k-bootstrap-sync': 'Синхронизировать файлы',
  'ed2k-bootstrap-cache': 'Локальный кэш',
  ...
  'ed2k-manual-servers': 'Ручные серверы',
