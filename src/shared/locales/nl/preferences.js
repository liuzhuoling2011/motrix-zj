export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Alle magnetbestanden standaard downloaden',
  'auto-select-all-magnet-files-from-extension-hint': 'Wanneer ingeschakeld, starten magnettaken stil',
