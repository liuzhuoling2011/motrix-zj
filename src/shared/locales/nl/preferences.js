export default {
  ...
  'app-log-path': 'Logbestand',
  'download-session-path': 'Sessiebestand',
  'session-reset': 'Alle taken verwijderen',
  'session-reset-confirm': 'Alle downloadtaken worden uit de engine verwijderd en het sessiebestand wordt gewist. De geschiedenis van voltooide downloads wordt niet beïnvloed.',
  ...
  'db-maintenance': 'Downloadgeschiedenis',
  'reset': 'Herstellen',
  'tray': 'Systeemvak',
  ...
  'session-path': 'Sessiebestand',
  'clear-all-tasks': 'Alle taken verwijderen',
  'clear-all-tasks-confirm': 'Alle downloadtaken worden uit de engine verwijderd en het sessiebestand wordt gewist. De geschiedenis van voltooide downloads wordt niet beïnvloed.',
  'log-section': 'App-log',
  'log-path': 'Logbestand',
