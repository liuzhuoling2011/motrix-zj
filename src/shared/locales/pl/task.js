export default {
  ...
  'apply': 'Zastosuj',
  'proxy-applied': 'Ustawienia proxy zastosowane',
  'proxy-applied-restart': 'Proxy zastosowane, zadanie połączy się ponownie',
  'proxy-apply-failed': 'Nie udało się zastosować ustawień proxy',
