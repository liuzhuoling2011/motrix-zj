export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Domyślnie pobieraj wszystkie pliki magnet',
  'auto-select-all-magnet-files-from-extension-hint': 'Po włączeniu zadania magnet uruchamiają się po cichu',
