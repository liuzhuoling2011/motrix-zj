export default {
  ...
  'db-check': 'Sprawdź bazę danych',
  'db-check-running': 'Sprawdzanie integralności bazy danych...',
  'db-check-ok': 'Baza danych jest w porządku',
  'db-check-fail': 'Sprawdzenie bazy danych nie powiodło się',
