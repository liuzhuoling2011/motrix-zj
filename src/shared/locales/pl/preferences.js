export default {
  ...
  'allow-remote-access-hint': 'Zezwalaj urządzeniom LAN na dostęp do aria2 RPC i API rozszerzenia',
  'remote-access-secret-required': 'Dostęp zdalny wymaga sekretu RPC i sekretu API rozszerzenia',
