export default {
  ...
  'hardware-rendering': 'Donanımsal İşleme (Linux)',
  'hardware-rendering-hint': 'Daha iyi performans için DMA-BUF GPU işlemeyi etkinleştirin. Çökmeye neden olursa otomatik olarak devre dışı bırakılır.',
  'hardware-rendering-restart-confirm': 'Donanımsal işleme değişikliği uygulamanın yeniden başlatılmasını gerektirir.',
