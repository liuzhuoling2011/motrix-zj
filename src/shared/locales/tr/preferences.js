export default {
  ...
  'db-check': 'Veritabanını kontrol et',
  'db-check-running': 'Veritabanı bütünlüğü kontrol ediliyor...',
  'db-check-ok': 'Veritabanı sorunsuz',
  'db-check-fail': 'Veritabanı kontrolü başarısız',
