export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Magnet dosyalarının tümünü varsayılan olarak indir',
  'auto-select-all-magnet-files-from-extension-hint': 'Etkinleştirildiğinde magnet görevleri sessizce başlar',
