export default {
  ...
  'app-log-path': 'Günlük Dosyası',
  'download-session-path': 'Oturum Dosyası',
  'session-reset': 'Tüm Görevleri Sil',
  'session-reset-confirm': 'Tüm indirme görevleri motordan kaldırılacak ve oturum dosyası silinecektir. Tamamlanan indirme geçmişi etkilenmeyecektir.',
  ...
  'db-maintenance': 'İndirme Geçmişi',
  'reset': 'Sıfırla',
  'tray': 'Sistem tepsisi',
  ...
  'session-path': 'Oturum Dosyası',
  'clear-all-tasks': 'Tüm Görevleri Sil',
  'clear-all-tasks-confirm': 'Tüm indirme görevleri motordan kaldırılacak ve oturum dosyası silinecektir. Tamamlanan indirme geçmişi etkilenmeyecektir.',
