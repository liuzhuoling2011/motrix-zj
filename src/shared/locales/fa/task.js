export default {
  ...
  'apply': 'اعمال',
  'proxy-applied': 'تنظیمات پروکسی اعمال شد',
  'proxy-applied-restart': 'پروکسی اعمال شد، وظیفه دوباره متصل خواهد شد',
  'proxy-apply-failed': 'اعمال تنظیمات پروکسی ناموفق بود',
  'task-error-info': 'خطا',
