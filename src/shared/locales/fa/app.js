export default {
  ...
  'engine-port-conflict-hint': 'علل احتمالی:\n• پورت {port} توسط برنامه دیگری اشغال شده است\n• VPN، پراکسی یا شتاب‌دهنده شبکه ارتباط محلی را رهگیری می‌کند\n• فایروال یا آنتی‌ویروس اتصال موتور را مسدود کرده است\n\nراه‌حل: در تنظیمات پیشرفته پورت موتور را تغییر دهید، یا نرم‌افزار مربوطه را موقتاً ببندید و دوباره امتحان کنید.',
