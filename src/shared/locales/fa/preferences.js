export default {
  ...
  'db-check': 'بررسی پایگاه داده',
  'db-check-running': 'در حال بررسی یکپارچگی پایگاه داده...',
  'db-check-ok': 'پایگاه داده سالم است',
  'db-check-fail': 'بررسی پایگاه داده ناموفق بود',
