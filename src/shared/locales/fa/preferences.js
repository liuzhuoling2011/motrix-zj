export default {
  ...
  'ed2k-bootstrap-hint': 'همگام‌سازی سرورهای ED2K و گره‌های Kad برای اتصال سریع‌تر',
  'ed2k-server-met-url': 'نشانی server.met',
  'ed2k-nodes-dat-url': 'نشانی nodes.dat',
  'ed2k-bootstrap-sync': 'همگام‌سازی فایل‌های راه‌اندازی',
  'ed2k-bootstrap-cache': 'کش محلی',
  'ed2k-bootstrap-last-sync': 'آخرین همگام‌سازی',
  ...
  'ed2k-manual-servers': 'سرورهای دستی',
