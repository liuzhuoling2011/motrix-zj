export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'دانلود همه فایل‌های مگنت به‌صورت پیش‌فرض',
  'auto-select-all-magnet-files-from-extension-hint': 'با فعال بودن، وظایف مگنت بی‌صدا شروع می‌شوند',
