export default {
  ...
  'proxy-system-socks-rejected': 'پروکسی سیستم از پروتکل SOCKS استفاده می‌کند که توسط aria2 پشتیبانی نمی‌شود',
  'proxy-mode-manual': 'دستی',
  'proxy-mode-system': 'پروکسی سیستم',
  'proxy-mode-none': 'مستقیم',
