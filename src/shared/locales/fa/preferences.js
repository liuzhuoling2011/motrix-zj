export default {
  ...
  'hardware-rendering-hint': 'رندرر WebKitGTK DMA-BUF را فعال می‌کند. به‌طور پیش‌فرض برای سازگاری غیرفعال است؛ عملکرد رندر را بهبود می‌بخشد اما در صورت بروز مشکل خودکار غیرفعال می‌شود.',
