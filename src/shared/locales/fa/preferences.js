export default {
  ...
  'app-log-path': 'فایل گزارش',
  'download-session-path': 'فایل نشست',
  'session-reset': 'پاک کردن همه وظایف',
  'session-reset-confirm': 'همه وظایف دانلود از موتور حذف شده و فایل نشست پاک می‌شود. تاریخچه دانلودهای تکمیل‌شده تحت تأثیر قرار نمی‌گیرد.',
  ...
  'engine-section': 'موتور',
  'session-path': 'فایل نشست',
  'clear-all-tasks': 'پاک کردن همه وظایف',
  'clear-all-tasks-confirm': 'همه وظایف دانلود از موتور حذف شده و فایل نشست پاک می‌شود. تاریخچه دانلودهای تکمیل‌شده تحت تأثیر قرار نمی‌گیرد.',
