export default {
  ...
  'hardware-rendering': 'رندر سخت‌افزاری (Linux)',
  'hardware-rendering-hint': 'فعال‌سازی رندر DMA-BUF GPU برای عملکرد بهتر. در صورت خرابی به‌طور خودکار غیرفعال می‌شود.',
  'hardware-rendering-restart-confirm': 'تغییر رندر سخت‌افزاری نیاز به راه‌اندازی مجدد برنامه دارد.',
