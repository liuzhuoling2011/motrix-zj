export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Download all magnet files by default',
  'auto-select-all-magnet-files-from-extension-hint': 'When enabled, magnet tasks start silently',
