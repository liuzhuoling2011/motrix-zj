export default {
  ...
  'allow-remote-access-hint': 'Allow LAN devices to access aria2 RPC and extension API',
  'remote-access-secret-required': 'Remote access requires both RPC Secret and Extension API Secret',
