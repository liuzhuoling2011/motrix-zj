export default {
  ...
  'download-session-path': 'Session File',
  'session-reset': 'Clear All Tasks',
  'session-reset-confirm': 'This will remove all download tasks from the engine and delete the session file. Completed download history will not be affected.',
  ...
  'db-maintenance': 'Download History',
  'reset': 'Reset',
  'tray': 'Tray',
  ...
  'clear-all-tasks-confirm': 'This will remove all download tasks from the engine and delete the session file. Completed download history will not be affected.',
  'log-section': 'App Log',
  'log-path': 'Log File',
  'clear-log': 'Clear Log',
