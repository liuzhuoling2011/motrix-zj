export default {
  ...
  'hardware-rendering': 'ハードウェアレンダリング (Linux)',
  'hardware-rendering-hint': 'DMA-BUF GPUレンダリングを有効にしてパフォーマンスを向上させます。クラッシュが発生した場合は自動的に無効になります。',
  'hardware-rendering-restart-confirm': 'ハードウェアレンダリングの変更はアプリの再起動後に有効になります。',
