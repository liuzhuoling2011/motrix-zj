export default {
  ...
  'app-log-path': 'ログファイル',
  'download-session-path': 'セッションファイル',
  'session-reset': 'すべてのタスクを消去',
  'session-reset-confirm': 'すべてのダウンロードタスクがエンジンから削除され、セッションファイルも消去されます。完了済みダウンロードの履歴は影響を受けません。',
  ...
  'engine-section': 'エンジン',
  'session-path': 'セッションファイル',
  'clear-all-tasks': 'すべてのタスクを消去',
  'clear-all-tasks-confirm': 'すべてのダウンロードタスクがエンジンから削除され、セッションファイルも消去されます。完了済みダウンロードの履歴は影響を受けません。',
  'log-section': 'アプリログ',
  'log-path': 'ログファイル',
  'clear-log': 'ログを消去',
