export default {
  ...
  'apply': 'Εφαρμογή',
  'proxy-applied': 'Οι ρυθμίσεις proxy εφαρμόστηκαν',
  'proxy-applied-restart': 'Proxy εφαρμόστηκε, η εργασία θα επανασυνδεθεί',
  'proxy-apply-failed': 'Αποτυχία εφαρμογής ρυθμίσεων proxy',
