export default {
  ...
  'ed2k-bootstrap-hint': 'Συγχρονίζει διακομιστές ED2K και κόμβους Kad για ταχύτερη σύνδεση',
  'ed2k-server-met-url': 'URL server.met',
  'ed2k-nodes-dat-url': 'URL nodes.dat',
  'ed2k-bootstrap-sync': 'Συγχρονισμός αρχείων εκκίνησης',
  'ed2k-bootstrap-cache': 'Τοπική προσωρινή μνήμη',
  ...
  'ed2k-manual-servers': 'Χειροκίνητοι διακομιστές',
