export default {
  ...
  'hardware-rendering-hint': 'Ενεργοποιεί τον WebKitGTK DMA-BUF renderer. Απενεργοποιημένο από προεπιλογή για συμβατότητα· βελτιώνει την απόδοση αλλά απενεργοποιείται αυτόματα αν προκαλέσει προβλήματα.',
