export default {
  ...
  'db-check': 'Έλεγχος βάσης δεδομένων',
  'db-check-running': 'Έλεγχος ακεραιότητας βάσης δεδομένων...',
  'db-check-ok': 'Η βάση δεδομένων είναι εντάξει',
  'db-check-fail': 'Αποτυχία ελέγχου βάσης δεδομένων',
