export default {
  ...
  'proxy-system-socks-rejected': 'Το proxy συστήματος είναι πρωτόκολλο SOCKS, μη υποστηριζόμενο από το aria2',
  'proxy-mode-manual': 'Χειροκίνητη',
  'proxy-mode-system': 'Proxy συστήματος',
  'proxy-mode-none': 'Άμεση',
