export default {
  ...
  'hardware-rendering': 'Απόδοση υλικού (Linux)',
  'hardware-rendering-hint': 'Ενεργοποίηση απόδοσης DMA-BUF GPU για καλύτερη επίδοση. Θα απενεργοποιηθεί αυτόματα αν προκαλέσει κατάρρευση.',
  'hardware-rendering-restart-confirm': 'Η αλλαγή απόδοσης υλικού απαιτεί επανεκκίνηση της εφαρμογής.',
