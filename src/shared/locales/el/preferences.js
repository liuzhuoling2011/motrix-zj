export default {
  ...
  'app-log-path': 'Αρχείο καταγραφής',
  'download-session-path': 'Αρχείο συνεδρίας',
  'session-reset': 'Εκκαθάριση όλων των εργασιών',
  'session-reset-confirm': 'Θα αφαιρεθούν όλες οι εργασίες λήψης από τη μηχανή και θα διαγραφεί το αρχείο συνεδρίας. Το ιστορικό ολοκληρωμένων λήψεων δεν θα επηρεαστεί.',
  ...
  'db-maintenance': 'Ιστορικό λήψεων',
  'reset': 'Επαναφορά',
  ...
  'engine-section': 'Μηχανή',
  'session-path': 'Αρχείο συνεδρίας',
  'clear-all-tasks': 'Εκκαθάριση όλων των εργασιών',
  'clear-all-tasks-confirm': 'Θα αφαιρεθούν όλες οι εργασίες λήψης από τη μηχανή και θα διαγραφεί το αρχείο συνεδρίας. Το ιστορικό ολοκληρωμένων λήψεων δεν θα επηρεαστεί.',
