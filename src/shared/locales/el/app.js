export default {
  ...
  'protocol-hijacked-title': 'Το προεπιλεγμένο πρόγραμμα άλλαξε',
  'protocol-hijacked-body': 'Το {protocols} δεν ανοίγει πλέον με το Motrix Next',
  'protocol-hijacked-dialog-content': 'Το προεπιλεγμένο πρόγραμμα για {protocols} αλλάχθηκε από άλλη εφαρμογή. Το Motrix Next δεν θα ανοίγει πλέον αυτόματα κατά το κλικ σε αυτούς τους συνδέσμους.\n\nΟ αντίστοιχος διακόπτης απενεργοποιήθηκε αυτόματα. Μπορείτε να τον ενεργοποιήσετε ξανά στις Ρυθμίσεις.',
  'dismiss': 'Κατάλαβα',
}
