export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'تنزيل كل ملفات المغناطيس افتراضيًا',
  'auto-select-all-magnet-files-from-extension-hint': 'عند التفعيل، تبدأ مهام المغناطيس بصمت',
