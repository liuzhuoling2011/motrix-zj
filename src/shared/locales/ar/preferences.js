export default {
  ...
  'hardware-rendering': 'تسريع العرض بالعتاد (Linux)',
  'hardware-rendering-hint': 'تمكين عرض DMA-BUF بوحدة معالجة الرسومات للحصول على أداء أفضل. سيتم التعطيل تلقائيًا إذا تسبب في تعطل.',
  'hardware-rendering-restart-confirm': 'يتطلب تغيير تسريع العرض بالعتاد إعادة تشغيل التطبيق ليصبح ساري المفعول.',
