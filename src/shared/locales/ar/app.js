export default {
  ...
  'engine-port-conflict-hint': 'الأسباب المحتملة:\n• المنفذ {port} مستخدم من قبل برنامج آخر\n• برنامج VPN أو وكيل أو مسرّع شبكة يعترض الاتصال المحلي\n• جدار الحماية أو مضاد الفيروسات يمنع اتصال المحرك\n\nالحل: انتقل إلى الإعدادات المتقدمة لتغيير منفذ المحرك، أو أغلق البرامج المعنية مؤقتًا وأعد المحاولة.',
