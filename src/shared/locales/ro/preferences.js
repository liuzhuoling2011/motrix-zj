export default {
  ...
  'app-log-path': 'Fișier jurnal',
  'download-session-path': 'Fișier sesiune',
  'session-reset': 'Șterge toate sarcinile',
  'session-reset-confirm': 'Toate sarcinile de descărcare vor fi eliminate din motor și fișierul de sesiune va fi șters. Istoricul descărcărilor finalizate nu va fi afectat.',
  ...
  'db-maintenance': 'Istoric descărcări',
  'reset': 'Resetare',
  'tray': 'Tava de sistem',
  ...
  'session-path': 'Fișier sesiune',
  'clear-all-tasks': 'Șterge toate sarcinile',
  'clear-all-tasks-confirm': 'Toate sarcinile de descărcare vor fi eliminate din motor și fișierul de sesiune va fi șters. Istoricul descărcărilor finalizate nu va fi afectat.',
  'log-section': 'Jurnal',
