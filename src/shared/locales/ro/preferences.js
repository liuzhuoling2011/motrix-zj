export default {
  ...
  'db-check': 'Verificare bază de date',
  'db-check-running': 'Se verifică integritatea bazei de date...',
  'db-check-ok': 'Baza de date este OK',
  'db-check-fail': 'Verificarea bazei de date a eșuat',
