export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Descarcă implicit toate fișierele magnet',
  'auto-select-all-magnet-files-from-extension-hint': 'Când este activat, sarcinile magnet pornesc silențios',
