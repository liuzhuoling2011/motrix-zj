export default {
  ...
  'apply': 'Aplică',
  'proxy-applied': 'Setările proxy au fost aplicate',
  'proxy-applied-restart': 'Proxy aplicat, sarcina se va reconecta',
  'proxy-apply-failed': 'Aplicarea setărilor proxy a eșuat',
