export default {
  ...
  'hardware-rendering-hint': 'เปิดใช้งาน WebKitGTK DMA-BUF renderer ปิดตามค่าเริ่มต้นเพื่อความเข้ากันได้ ปรับปรุงประสิทธิภาพการเรนเดอร์แต่จะปิดอัตโนมัติหากเกิดปัญหา',
