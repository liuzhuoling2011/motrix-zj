export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'ดาวน์โหลดไฟล์ magnet ทั้งหมดเป็นค่าเริ่มต้น',
  'auto-select-all-magnet-files-from-extension-hint': 'เมื่อเปิดใช้ งาน magnet จะเริ่มแบบเงียบ',
