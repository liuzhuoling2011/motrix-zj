export default {
  ...
  'ed2k-bootstrap-hint': 'ซิงค์เซิร์ฟเวอร์ ED2K และโหนด Kad เพื่อเชื่อมต่อเครือข่ายได้เร็วขึ้น',
  'ed2k-server-met-url': 'URL server.met',
  'ed2k-nodes-dat-url': 'URL nodes.dat',
  'ed2k-bootstrap-sync': 'ซิงค์ไฟล์เริ่มต้น',
  'ed2k-bootstrap-cache': 'แคชในเครื่อง',
  'ed2k-bootstrap-last-sync': 'ซิงค์ล่าสุด',
  ...
  'ed2k-manual-servers': 'เซิร์ฟเวอร์กำหนดเอง',
