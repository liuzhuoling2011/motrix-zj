export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Descargar todos los archivos magnet por defecto',
  'auto-select-all-magnet-files-from-extension-hint': 'Al activarlo, las tareas magnet comenzarán en silencio',
