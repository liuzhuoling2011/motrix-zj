export default {
  ...
  'db-check': 'Comprobar base de datos',
  'db-check-running': 'Comprobando la integridad de la base de datos...',
  'db-check-ok': 'La base de datos está bien',
  'db-check-fail': 'Error en la comprobación de la base de datos',
