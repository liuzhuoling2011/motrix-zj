export default {
  ...
  'proxy-unsupported-protocol': 'Непідтримуваний протокол проксі. Aria2 Next підтримує лише HTTP-проксі (http/https/ftp).',
  ...
  'port-conflict-recovery-range-hint': 'Використовується, коли керований порт зайнятий. Обраний порт має бути вільним і для TCP, і для UDP.',
  ...
  'silent-auto-submit-from-extension': 'Обробляти завантаження розширення у фоні',
  'silent-auto-submit-from-extension-tip':
    'Коли підтвердження пропущено, завантаження розширення приймаються без показу головного вікна.',
