export default {
  ...
  'allow-remote-access-hint': 'Дозволити пристроям LAN доступ до aria2 RPC та API розширення',
  'remote-access-secret-required': 'Для віддаленого доступу потрібні секрет RPC і секрет API розширення',
