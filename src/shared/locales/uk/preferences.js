export default {
  ...
  'proxy-system-socks-rejected': 'Системний проксі використовує протокол SOCKS, непідтримуваний aria2',
  'proxy-mode-manual': 'Ручний',
  'proxy-mode-system': 'Системний проксі',
  'proxy-mode-none': 'Пряме',
