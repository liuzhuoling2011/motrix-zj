export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Типово завантажувати всі файли magnet',
  'auto-select-all-magnet-files-from-extension-hint': 'Якщо ввімкнено, завдання magnet запускатимуться тихо',
