export default {
  ...
  'db-check': 'Перевірити базу даних',
  'db-check-running': 'Перевірка цілісності бази даних...',
  'db-check-ok': 'База даних у порядку',
  'db-check-fail': 'Перевірка бази даних не вдалася',
