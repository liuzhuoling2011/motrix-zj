export default {
  ...
  'hardware-rendering': 'Апаратний рендеринг (Linux)',
  'hardware-rendering-hint': 'Увімкнути DMA-BUF GPU рендеринг для кращої продуктивності. Автоматично вимкнеться у разі збою.',
  'hardware-rendering-restart-confirm': 'Зміна апаратного рендерингу потребує перезапуску програми.',
