export default {
  ...
  'hardware-rendering-hint': 'Вмикає рендерер WebKitGTK DMA-BUF. Вимкнено за замовчуванням для сумісності; покращує продуктивність рендерингу, але автоматично вимикається у разі проблем.',
