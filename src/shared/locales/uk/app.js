export default {
  ...
  'engine-port-conflict-hint': 'Можливі причини:\n• Порт {port} зайнятий іншою програмою\n• VPN, проксі або мережевий прискорювач перехоплює локальне з\u0027єднання\n• Брандмауер або антивірус блокує підключення рушія\n\nРішення: Змініть порт рушія в Розширених налаштуваннях або тимчасово закрийте конфліктне ПЗ та повторіть спробу.',
