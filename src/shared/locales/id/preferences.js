export default {
  ...
  'app-log-path': 'File Log',
  'download-session-path': 'File Sesi',
  'session-reset': 'Hapus Semua Tugas',
  'session-reset-confirm': 'Semua tugas unduhan akan dihapus dari mesin dan file sesi akan dihapus. Riwayat unduhan yang sudah selesai tidak akan terpengaruh.',
  ...
  'db-maintenance': 'Riwayat Unduhan',
  'reset': 'Atur Ulang',
  'tray': 'Baki sistem',
  ...
  'engine-section': 'Mesin',
  'session-path': 'File Sesi',
  'clear-all-tasks': 'Hapus Semua Tugas',
  'clear-all-tasks-confirm': 'Semua tugas unduhan akan dihapus dari mesin dan file sesi akan dihapus. Riwayat unduhan yang sudah selesai tidak akan terpengaruh.',
