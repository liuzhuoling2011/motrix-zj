export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Unduh semua file magnet secara default',
  'auto-select-all-magnet-files-from-extension-hint': 'Saat diaktifkan, tugas magnet dimulai secara senyap',
