export default {
  ...
  'ed2k-bootstrap-hint': 'Sinkronkan server ED2K dan node Kad agar koneksi jaringan lebih cepat',
  'ed2k-server-met-url': 'URL server.met',
  'ed2k-nodes-dat-url': 'URL nodes.dat',
  'ed2k-bootstrap-sync': 'Sinkronkan File Bootstrap',
  'ed2k-bootstrap-cache': 'Cache Lokal',
  'ed2k-bootstrap-last-sync': 'Sinkronisasi Terakhir',
  ...
  'ed2k-manual-servers': 'Server Manual',
