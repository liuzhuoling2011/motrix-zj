export default {
  ...
  'proxy-system-socks-rejected': 'Proxy sistem menggunakan protokol SOCKS yang tidak didukung oleh aria2',
  'proxy-mode-manual': 'Manual',
  'proxy-mode-system': 'Proxy sistem',
  'proxy-mode-none': 'Langsung',
