export default {
  ...
  'apply': 'Terapkan',
  'proxy-applied': 'Pengaturan proxy diterapkan',
  'proxy-applied-restart': 'Proxy diterapkan, tugas akan menghubungkan ulang',
  'proxy-apply-failed': 'Gagal menerapkan pengaturan proxy',
