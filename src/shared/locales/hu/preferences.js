export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Minden magnet-fájl letöltése alapértelmezés szerint',
  'auto-select-all-magnet-files-from-extension-hint': 'Bekapcsolva a magnet feladatok csendben indulnak',
