export default {
  ...
  'db-check': 'Adatbázis ellenőrzése',
  'db-check-running': 'Adatbázis integritás ellenőrzése...',
  'db-check-ok': 'Az adatbázis rendben van',
  'db-check-fail': 'Adatbázis ellenőrzés sikertelen',
