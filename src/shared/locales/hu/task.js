export default {
  ...
  'apply': 'Alkalmaz',
  'proxy-applied': 'Proxy beállítások alkalmazva',
  'proxy-applied-restart': 'Proxy alkalmazva, a feladat újracsatlakozik',
  'proxy-apply-failed': 'Proxy beállítások alkalmazása sikertelen',
