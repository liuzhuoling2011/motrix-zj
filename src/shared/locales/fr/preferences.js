export default {
  ...
  'app-log-path': 'Fichier journal',
  'download-session-path': 'Fichier de session',
  'session-reset': 'Supprimer toutes les tâches',
  'session-reset-confirm': 'Toutes les tâches de téléchargement seront supprimées du moteur et le fichier de session sera effacé. L\'historique des téléchargements terminés ne sera pas affecté.',
  ...
  'db-maintenance': 'Historique des téléchargements',
  'reset': 'Réinitialiser',
