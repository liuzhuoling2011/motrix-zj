export default {
  ...
  'db-check': 'Vérifier la base de données',
  'db-check-running': 'Vérification de l\'intégrité de la base de données...',
  'db-check-ok': 'La base de données est OK',
  'db-check-fail': 'Échec de la vérification de la base de données',
