export default {
  ...
  'auto-select-all-magnet-files-from-extension': 'Mặc định tải xuống mọi tệp magnet',
  'auto-select-all-magnet-files-from-extension-hint': 'Khi bật, tác vụ magnet sẽ bắt đầu âm thầm',
