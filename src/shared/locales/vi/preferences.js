export default {
  ...
  'hardware-rendering': 'Dựng hình phần cứng (Linux)',
  'hardware-rendering-hint': 'Bật dựng hình DMA-BUF GPU để có hiệu suất tốt hơn. Sẽ tự động tắt nếu gây ra sự cố.',
  'hardware-rendering-restart-confirm': 'Thay đổi dựng hình phần cứng sẽ có hiệu lực sau khi khởi động lại ứng dụng.',
