export default {
  ...
  'db-check': 'Kiểm tra cơ sở dữ liệu',
  'db-check-running': 'Đang kiểm tra tính toàn vẹn cơ sở dữ liệu...',
  'db-check-ok': 'Cơ sở dữ liệu bình thường',
  'db-check-fail': 'Kiểm tra cơ sở dữ liệu thất bại',
